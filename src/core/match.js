...
export const PT_QUERIES = {
  ...
  eggs: { all: ['ovos'], some: ['classe', 'duzia', 'solo', 'ar livre', 'campo', 'gaiola', 'biologico', 'frescos'], none: ['codorniz', 'chocolate', 'cozidos', 'clara', 'gema', 'pascoa', 'liquid', 'moles', 'fios de ovos', 'trouxas', 'creme de ovos', 'ovos doces', 'massa', 'pao', 'bolo', 'em po'] },
  ...
  carrots: { all: ['cenoura'], none: ['ralada', 'baby', 'sumo', 'bebe', 'sopa', 'bolo', 'mistura', 'creme', 'pure', 'palitos'] },
  courgette: { some: ['curgete', 'courgette'], none: ['espirais', 'creme', 'sopa', 'esparguete', 'caril', 'abobora', 'frango', 'mistura', 'salteado'] },
  green_beans: { all: ['feijao verde'], none: ['salteado', 'mistura', 'sopa'] },
  spinach: { all: ['espinafre'], none: ['creme', 'esparregado', 'lasanha', 'queijo', 'sopa', 'mistura', 'bebe', 'sumo', 'baby', 'massa'] },
  ...
  tomato: { all: ['tomate'], none: ['polpa', 'pelado', 'concentrado', 'ketchup', 'molho', 'cherry', 'seco', 'sumo', 'triturado', 'frito', 'passata', 'salada', 'sopa', 'doce de', 'gaspacho', 'pure', 'semente'] },
  cucumber: { all: ['pepino'], none: ['pickle', 'conserva', 'vinagre', 'pepino doce', 'gaspacho', 'pepininho', 'salada'] },
  ...
  lemon: { all: ['limao'], none: ['pudim', 'gelado', 'sorbet', 'iogurte', 'kefir', 'doce de', 'compota', 'marmelada', 'geleia', 'bolo', 'torta', 'tarte', 'mousse', 'gomas', 'gelatina', 'sumo', 'nectar', 'batido', 'bebida', 'licor', 'aroma', 'sabor', 'cereais', 'barra', 'chocolate', 'ice tea', 'refrigerante', 'agua', 'cha', 'bolach', 'raspas', 'gin', 'cerveja', 'sabonete', 'detergente'] },
  banana: { all: ['banana'], none: ['pudim', 'gelado', 'sorbet', 'iogurte', 'kefir', 'doce de', 'compota', 'marmelada', 'geleia', 'bolo', 'torta', 'tarte', 'mousse', 'gomas', 'gelatina', 'sumo', 'nectar', 'batido', 'bebida', 'licor', 'aroma', 'sabor', 'cereais', 'barra', 'chocolate', 'chips', 'seca', 'desidratad', 'pao', 'papa', 'assar', 'pure'] },
  ...
  kiwi: { all: ['kiwi'], none: ['pudim', 'gelado', 'sorbet', 'iogurte', 'kefir', 'doce de', 'compota', 'marmelada', 'geleia', 'bolo', 'torta', 'tarte', 'mousse', 'gomas', 'gelatina', 'sumo', 'nectar', 'batido', 'bebida', 'licor', 'aroma', 'sabor', 'cereais', 'barra', 'chocolate'] },
  ...
  strawberries: { all: ['morango'], none: ['pudim', 'gelado', 'sorbet', 'iogurte', 'kefir', 'doce de', 'compota', 'marmelada', 'geleia', 'bolo', 'torta', 'tarte', 'mousse', 'gomas', 'gelatina', 'sumo', 'nectar', 'batido', 'bebida', 'licor', 'aroma', 'sabor', 'cereais', 'barra', 'chocolate', 'congelad', 'frubis', 'gel', 'leite', 'doony'] },
  blueberries: { all: ['mirtilo'], none: ['pudim', 'gelado', 'sorbet', 'iogurte', 'kefir', 'doce de', 'compota', 'marmelada', 'geleia', 'bolo', 'torta', 'tarte', 'mousse', 'gomas', 'gelatina', 'sumo', 'nectar', 'batido', 'bebida', 'licor', 'aroma', 'sabor', 'cereais', 'barra', 'chocolate', 'desidratad', 'seco', 'muffin', 'doony'] },
